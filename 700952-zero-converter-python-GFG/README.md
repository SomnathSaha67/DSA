# [Zero Converter - Python](https://www.geeksforgeeks.org/problems/zero-converter-python/1)
## Easy
...
Output:
-3 -2 -1 0
Your Task:This is a function problem. You don't need to take input of test cases. Just complete the functions pos() and neg().
Constraints:-103&nbsp;&lt;= x &lt;= 103