# [Rotate and delete](https://www.geeksforgeeks.org/problems/rotate-and-delete-1587115621/1)
## Medium
...
Now, Return the first element of the array.Note: Here n keeps on decreasing with every operation.
Examples:
